          ...
          <div className="grid grid-cols-2 gap-4 md:gap-16 p-4 max-w-4xl mx-auto text-center">
            <div className="md:justify-self-end">
              <p>
                <a
                  ...
                  className="text-white hover:text-brand-01 transition text-sm"
                >
            ...
            <div className="md:justify-self-start">
              ...
              <Link
                ...
                target="_blank"
                className="cursor-pointer inline-block border border-white text-white px-4 py-2 rounded hover:bg-brand-01 hover:text-white transition"
              >
                Download CV
              </Link>
            </div>
